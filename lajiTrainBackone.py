...
parser.add_argument('--weight', default=16, type=int)

parser.add_argument('--log_path', default='logs/',
                    help='Directory for saving checkpoint models')
parser.add_argument('--net_name', default='ssd300_se_resnext50_32x4d',
                    help='Directory for saving checkpoint models')
parser.add_argument('--save_path', default='weights/train_weights/',
                    help='Directory for saving checkpoint models')
parser.add_argument('--config', default='new_lr_mosaic_correct_transform_full_data_ciou_sgd_1gpu_6_16',
                    help='Directory for saving checkpoint models')
...
def train():
    ...
    for epoch in range(start_iter, args.max_epoch):
        ...
        for ii, batch_iterator in enumerate(progress_bar):
            ...
            if epoch in lr_need_steps:
                lr_need_steps.remove(epoch)
                step_index += 1
