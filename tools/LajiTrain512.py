...
from data import *
from config import crack,voc, laji, laji512
...
parser.add_argument('--dataset', default='LAJI512', choices=['LAJI', 'VOC', 'COCO','CRACK','TRAFIC'],
...
parser.add_argument('--log_path', default='logs/',
                    help='Directory for saving checkpoint models')
parser.add_argument('--net_name', default='ssd512',
                    help='Directory for saving checkpoint models')
