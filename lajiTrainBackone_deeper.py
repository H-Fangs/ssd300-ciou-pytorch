...
parser.add_argument('--log_path', default='logs/',
                    help='Directory for saving checkpoint models')
parser.add_argument('--net_name', default='ssd300_laji_se_resnext101_32x4d',
                    help='Directory for saving checkpoint models')
parser.add_argument('--save_path', default='weights/train_weights/',
                    help='Directory for saving checkpoint models')
parser.add_argument('--config', default='new_lr_correct_transform_full_data_ciou_sgd_1gpu_6_19_fighting',
                    help='Directory for saving checkpoint models')
